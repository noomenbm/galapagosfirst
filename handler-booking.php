...
$pp = new FormHandler('New Booking request'); 

$validator = $pp->getValidator();
$validator->fields(['Name','tourname','Email','prefdate','numtravelers'])->areRequired()->maxLength(50);
$validator->field('Email')->isEmail();
$validator->field('Message')->maxLength(6000);

$mailer = $pp->getMailer();
$mailer->setFrom('forms@s737232254.onlinehome.us','Form');
